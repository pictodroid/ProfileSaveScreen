...
public  class DeviceListActivity {
	...
	/*Comment: This package is not in the V.1.0.0 and is in V.1.1.0 please exclude from the Build Path.
	 * Source: the users device
	 * Sink: nearby bluetooth connections found, multiple connection handling possible for bluetooths 4 gen type
	 * Registration: automated.
	 * Connection: One button to select Selection and OK to confirm. 
	 */
