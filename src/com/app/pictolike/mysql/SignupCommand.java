...
class SignupCommand extends MySQLCommand {
	...
	SignupCommand(String name, String email, String password, String gender, String birthday) {
		...
		//m_strRepeatPassword=repeatPassword;
		m_strGender= gender;
	...
	void command() {
		...
		try {
			...
			//nameValuePair.add(new BasicNameValuePair(MySQLConnect.FIELD_REPEATPASSWORD, m_strRepeatPassword));
